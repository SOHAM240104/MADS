...
class Encoder(nn.Module):
    ...
    def forward(self, src):
        ...
        # Apply layer normalization to the concatenated hidden states
...
class Attention(nn.Module):
    def __init__(self, enc_hid_dim, dec_hid_dim):
        ...
        # Add dropout to attention mechanism
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        energy = self.dropout(energy)  # Apply dropout to attention energy
